...
int main()
{
	...
	do
	{
		...
		cin >> annual_salary;
		cout << "Enter the number of months for which u wish to calculate retroactive pay for: ";
		...
		cout << "The retroactive owed to you is: " << (new_monthly_salary - monthly_salary) * number_of_months << endl;
